...
export default function ClustersPage() {
  ...
  const handleDelete = async (e: React.MouseEvent, cluster: Cluster) => {
    e.stopPropagation()
    const confirmed = window.confirm(
      `Delete "${cluster.name}"? Its ${cluster.leadCount} leads will be unassigned.`
    )
    if (!confirmed) return
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          onClick={(e) => handleDelete(e, cluster)}
                        >
