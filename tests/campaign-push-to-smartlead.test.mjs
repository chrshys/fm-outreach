...
test("Push to Smartlead button uses Rocket icon", () => {
  // The button with "Push to Smartlead" text should have a Rocket icon
  const buttonSection = source.match(/Push to Smartlead[\s\S]{0,200}/)
  assert.ok(buttonSection)
  // Rocket icon appears before the button text
